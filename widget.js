...
cprequire_test(["inline:net-fka-ck-tabs"], function(myWidget) {
...
cpdefine("inline:net-fka-ck-tabs", ["chilipeppr_ready", /* other dependencies here */ ], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "net-fka-ck-tabs", // Make the id the same as the cpdefine id
        name: "Widget / Tabs", // The descriptive name of your widget.
        desc: "Tabs. Contains all usable widgets out of the workspace ", // A description of what your widget does
